    ...
    public static void main(String[] args) throws IOException {
        ...
        do {
            ...
            if (op1 == 1) {
                ...
                // Insertar libro
                String titulo, fechaPublicado, isbn, nombreGenero;
                int generoId;
                ...
                while (true) {
                    ...
                    generoId = generoControlador.buscarIdGenero(nombreGenero);
                    if (generoId != -1) {
                        break;
                    } else {
                        System.out.println("Nombre de género no válido. ¿Volver a intentarlo? (si/no):");
                        if (!es.nextLine().equalsIgnoreCase("si")) {
                            datosCorrectos = false;
                            break;
                        }
                ...
                if (!datosCorrectos) {
                    ...
                    ArrayList<Libros> libros = libroControlador.listarLibros();
                    if (libros.isEmpty()) {
                        System.out.println("No hay libros disponibles.");
                    } else {
                        for (Libros libro : libros) {
                            System.out.println("Título: " + libro.getTitulo() +
                                               ", Fecha de Publicación: " + libro.getFechaPublicado() +
                                               ", ISBN: " + libro.getIsbn());
                        }
                    }
                }
