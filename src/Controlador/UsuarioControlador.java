...
public class UsuarioControlador {
    ...
    public void crearUsuario(Usuario p) {
        try {// EXCEPCION QUE LANZA LA CONSULATA
            String consultaSQL = "INSERT INTO usuarios( usu_nombres,usu_apellidos,usu_clave,usu_cedula,usu_direccion,usu_telefono,usu_correolnstitucional,usu_rol)VALUES('" + usuC.getNombres() + "','" + usuC.getApellidos() + "','" + usuC.getClave() + "','" + usuC.getCedula() + "','" + usuC.getDireccion() + "','" + usuC.getTelefono() + "','" + usuC.getCorreoInstitucional() + "', " + usuC.getRol() + ");";
